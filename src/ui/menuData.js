...
export const OFICIO_SKILLS = [
  ...
  { key: 'navegacao', icon: 'navegacao', name: 'Navegação', real: true, trainedBy: 'Sobe viajando de barco entre ilhas.' },
  { key: 'natacao', icon: 'natacao', name: 'Natação', real: false, trainedBy: 'Sem natação de verdade ainda.' },
  { key: 'pesca', icon: 'pesca', name: 'Pesca', real: true, trainedBy: 'Sobe pescando com uma vara equipada.' },
  { key: 'caca', icon: 'caca', name: 'Caça', real: true, trainedBy: 'Sobe caçando minhocas pra usar de isca.' },
